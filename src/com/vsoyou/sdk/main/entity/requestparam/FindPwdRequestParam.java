...
public class FindPwdRequestParam extends DeviceInfo implements Serializable {
	...
	public FindPwdRequestParam(Context context, String userName) {
		super(context);
	...
	public String toJson() {
		...
		try {
			...
			LogUtil.e("FindPwdRequestParam.toJson", "" + e);
		}
