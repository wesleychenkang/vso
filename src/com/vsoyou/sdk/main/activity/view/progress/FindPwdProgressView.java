...
public class FindPwdProgressView extends BasicWindowView implements ProgressView {

    private ProgressContentView progressContentView;

    public FindPwdProgressView(Context context) {
        super(context);
    }

    public FindPwdProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public FindPwdProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(Context context) {
        ...
        progressContentView.setText("寻找密码中...");
