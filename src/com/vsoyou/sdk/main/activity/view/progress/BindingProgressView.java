...
public class BindingProgressView extends BasicWindowView implements ProgressView {

    private ProgressContentView progressContentView;

    public BindingProgressView(Context context) {
        super(context);
    }

    public BindingProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public BindingProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(Context context) {
        ...
        progressContentView.setText("绑定邮箱中...");
