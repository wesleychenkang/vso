...
public class LoginProgressView extends BasicWindowView implements ProgressView {
    ...
    public LoginProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(Context context) {
        ...
        progressContentView.setText("登陆中...");
