...
public class RegisterProgressView extends BasicWindowView implements ProgressView {
    ...
    public RegisterProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public RegisterProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(Context context) {
        ...
        progressContentView.setText("注册中...");
