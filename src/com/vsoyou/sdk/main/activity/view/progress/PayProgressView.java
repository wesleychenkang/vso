...
public class PayProgressView extends BasicWindowView implements ProgressView {
    ...
    public PayProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(Context context) {
        ...
        progressContentView.setText("支付中...");
