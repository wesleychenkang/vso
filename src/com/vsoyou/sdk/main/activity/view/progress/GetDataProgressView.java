...
public class GetDataProgressView extends BasicWindowView implements ProgressView {

    private ProgressContentView progressContentView;

    public GetDataProgressView(Context context) {
        super(context);
    }

    public GetDataProgressView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public GetDataProgressView(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void init(Context context) {
        ...
        progressContentView.setText("数据加载中...");
