package com.vsoyou.sdk.main.third.alipay;
...
public class Result {
	...
	public Result(String result, PayTypeEntity payTypeEntity) {
		this.mResult = result;
	...
	private  boolean checkSign(String result) {
		...
		try {
			...
			if (signType.equalsIgnoreCase("RSA")) {
				retVal = Rsa.doCheck(signContent, sign, payTypeEntity.public_Key);
			}
		} catch (Exception e) {
			e.printStackTrace();
			LogUtil.i("Result", "Exception =" + e);
		}
		LogUtil.i("Result", "checkSign =" + retVal);
		return retVal;
	}
